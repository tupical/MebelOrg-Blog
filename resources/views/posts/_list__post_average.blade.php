<a href="{{ route('posts.show', $post)}}">
    <div class="news news__average"  style="background-image: url(@if ($post->image_preview) {{asset('/storage/images/post/' . $post->image_preview)}} @else /storage/images/post/default.jpg @endif);">
